...
\begin{itemize}
    ...
    \item K-means : une méthode de clustering qui permet de regrouper les segments textuels en fonction de leur proximité lexicale.\footnote{Richard O. Duda, Peter E. Hart et David G. Stork, \textit{Pattern Classification}, Wiley-Interscience, 2001.}.
\end{itemize}
